...
class PhpmailerLib {
  ...
  public function __construct($exceptions = false) {
    ...
    $this->SMTPAuth=true;
    $this->SMTPSecure = 'tls';
    $this->Host = App::$smtp_host; 
    $this->Port = App::$smtp_port;
    $this->Username= App::$smtp_email;
    $this->Password = App::$smtp_pass;
    $this->CharSet = 'UTF-8';
    $this->Encoding = '8bit';
    $this->IsHTML(true);
    $this->From = App::$smtp_email;
    $this->FromName = App::$company_name; 
  }
